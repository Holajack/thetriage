 ...
 */
export async function injectMockAuth(page: any): Promise<void> {
  await page.addInitScript(
    (data: any) => {
      ...
      localStorage.setItem(
        "hikewise-mock-leaderboard",
        JSON.stringify(leaderboard),
      );
      localStorage.setItem(
        "hikewise-mock-analytics",
...
export async function waitForAppReady(
  ...
  await page
    .waitForSelector('[data-testid="app-root"]', { timeout })
    .catch(() => {
