...
const brainModelPath = path.join(
  __dirname,
  "src/assets/Brain_MRI_Nevit%20Dilmen_NIH3D.gltf",
);
...
if (exists) {
  ...
  if (stats.size > 5 * 1024 * 1024) {
    // > 5MB
    console.log(
      "⚠️  WARNING: File size too large for optimal mobile performance",
    );
    console.log("");
    ...
    console.log(
      "   gltf-transform optimize brain-optimized.gltf brain-final.gltf",
    );
    console.log("");
