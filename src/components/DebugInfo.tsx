    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.debugText}>
            hasSeenLanding: {String(hasSeenLanding)}
          </Text>
          <Text style={styles.debugText}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.debugText}>
            Onboarding ID: {onboarding?.id || "null"}
          </Text>
          <Text style={styles.debugText}>
            User ID: {onboarding?.user_id || "null"}
          </Text>
          <Text style={styles.debugText}>
            Is Complete: {String(onboarding?.is_onboarding_complete)}
          </Text>
          <Text style={styles.debugText}>
            Learning Environment: {onboarding?.learning_environment || "null"}
          </Text>
          <Text style={styles.debugText}>
            User Goal: {onboarding?.user_goal || "null"}
          </Text>
        </View>
