...
const MOTIVATIONAL_QUOTES: Quote[] = [
  ...
  {
    quote:
      "Concentrate your energies, your thoughts and your capital. Put all your eggs in one basket, and then watch that basket.",
  ...
  {
    quote:
      "My success is not a matter of having incredible talent. I simply have focused on something I loved.",
  ...
  {
    quote:
      "Intelligence is not fixed. The more you learn, the smarter you become.",
    author: "Carol Dweck",
    category: "growth",
  },
  {
  ...
  {
    quote: "It's not what you know, it's what you do with what you know.",
    author: "Unknown",
    category: "growth",
  },
  {
  ...
  {
    quote: "Little progress is still progress.",
    author: "Unknown",
    category: "success",
  },
  {
  ...
  {
    quote: "Studying is not about time, it's about focus.",
    author: "Unknown",
    category: "focus",
  },
  {
    quote:
      "The secret to getting ahead is getting started. The secret to getting started is breaking down your complex tasks into small manageable tasks.",
    author: "Mark Twain",
    category: "focus",
  },
  {
  ...
  {
    quote: "Time is the most valuable thing a person can spend.",
    author: "Theophrastus",
    category: "focus",
  },
  {
...
function getQuoteByCategory(category: Quote["category"]): Quote {
