...
import {
  PatrickSpeakScreen,
  QuizzesScreen,
} from "../screens/main/PatrickScreen";
...
function CustomTabBar(props: BottomTabBarProps) {
  ...
  const indicatorStyle = useAnimatedStyle(() => ({
    transform: [{ translateX: indicatorPosition.value * (tabWidth / numTabs) }],
  }));
  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        ...
        options={{ tabBarButton: () => null, headerRight: () => null }}
      />
      <Tab.Screen
        name="PDFViewer"
