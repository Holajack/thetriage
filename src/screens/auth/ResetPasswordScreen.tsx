      ...
      if (result.status === "complete") {
        ...
        try {
          ...
          if (
            ...
            // RN compatibility error (session likely active)
          } else {
            // setActive error
          }
        }
          ...
          [
            {
              text: "Continue",
              onPress: () => {
                // Navigating to Main after password reset
                navigation.dispatch(
                  CommonActions.reset({
                    index: 0,
            ...
            <View style={styles.content}>
              ...
              <Animated.View style={iconAnimation}>
                ...
                <Text style={[styles.subtitle, { color: secondaryTextColor }]}>
                  ...
                  {email ? ` (${email})` : ""} and your new password
                </Text>
              </Animated.View>
              ...
              <Animated.View
                style={[confirmPasswordAnimation, styles.inputContainer]}
              >
                <Text style={[styles.label, { color: textColor }]}>
                  Confirm Password
                </Text>
              ...
              <View style={styles.requirementsContainer}>
                ...
                <Text
                  style={[styles.requirement, { color: secondaryTextColor }]}
                >
