...
const AIIntegrationScreen = () => {
  ...
  const handleAIToggle = async (aiType: string, value: boolean) => {
    try {
      ...
      Alert.alert(
        "Success",
        `${aiType} AI ${value ? "enabled" : "disabled"} successfully`,
      );
    } catch (error) {
  ...
  const handlePersonalizationToggle = async (
    ...
    try {
      ...
      if (settingType === "personalized_responses")
        setPersonalizedResponses(value);
      if (settingType === "contextual_suggestions")
        setContextualSuggestions(value);

      Alert.alert("Success", "Setting updated successfully");
    } catch (error) {
      // Error updating personalization setting
        ...
        <ScrollView style={{ flex: 1, paddingHorizontal: 20 }}>
          ...
          <View style={styles.modalHeader}>
            <Text
              style={[
                styles.modalTitle,
                { fontSize: fontSize * 1.5, color: theme.primary },
              ]}
            >
              Nora AI Assistant
            </Text>
          ...
          >
            Nora is your intelligent study companion designed to help you
            achieve academic excellence. She provides personalized study
            assistance, answers questions, and helps you develop effective
            learning strategies.
          </Text>
          ...
          <Text
            style={[
              styles.sectionTitle,
              { fontSize: fontSize * 1.2, color: theme.primary },
            ]}
          >
            Features
          </Text>
          ...
          <View
            style={[styles.featureItem, { borderLeftColor: theme.primary }]}
          >
            <Ionicons
            ...
            <View style={{ marginLeft: 12, flex: 1 }}>
              <Text
                style={[
                  styles.featureTitle,
                  { fontSize: fontSize * 1.1, color: theme.text },
                ]}
              >
                Intelligent Chat
              </Text>
              <Text
                style={[
                  styles.featureDesc,
                  { fontSize: fontSize * 0.9, color: theme.textSecondary },
                ]}
              >
                Natural conversation interface for asking study-related
                questions and getting detailed explanations
              </Text>
            </View>
          </View>
          ...
          >
            ...
            <View style={{ marginLeft: 12, flex: 1 }}>
              ...
              >
                Upload study materials and get summaries, question generation,
          ...
          >
            ...
            <View style={{ marginLeft: 12, flex: 1 }}>
              ...
              >
                Personalized learning techniques based on your study patterns
                and preferences
              </Text>
            </View>
          </View>
          ...
          <View style={[styles.settingItem, { backgroundColor: theme.card }]}>
            ...
            <Switch
              ...
              onValueChange={(value) =>
                handlePersonalizationToggle("personalized_responses", value)
              }
              trackColor={{ false: theme.border, true: theme.primary }}
              thumbColor={
                personalizedResponses ? "#FFFFFF" : theme.textSecondary
              }
            />
          </View>
          ...
          >
            <Text
              style={[
                styles.ackText,
                { fontSize: fontSize * 0.9, color: theme.text },
              ]}
            >
              • Nora processes your study data to provide personalized
              assistance{"\n"}• Chat conversations are stored to improve
              response quality{"\n"}• PDF content is analyzed securely and not
    ...
    >
      <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
        <ScrollView style={{ flex: 1, paddingHorizontal: 20 }}>
          ...
          >
            Patrick is your voice-activated study companion that provides audio
            feedback, motivational support, and hands-free interaction during
            your focus sessions.
          </Text>
          ...
          >
            ...
            <View style={{ marginLeft: 12, flex: 1 }}>
              ...
              >
                Start timers, get progress updates, and control app functions
                using voice
              </Text>
            </View>
          </View>
          ...
          >
            ...
            <View style={{ marginLeft: 12, flex: 1 }}>
              ...
              >
                Spoken notifications, session summaries, and motivational
                messages
              </Text>
            </View>
          </View>
          ...
          >
            ...
            >
              ...
              data may be sent to speech recognition services{"\n"}• No voice
              recordings are permanently stored{"\n"}• You can disable voice
    ...
    >
      <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
        <ScrollView style={{ flex: 1, paddingHorizontal: 20 }}>
          ...
          >
            AI Insights analyzes your study patterns, performance trends, and
            learning behaviors to provide personalized recommendations for
          ...
          >
            ...
            <View style={{ marginLeft: 12, flex: 1 }}>
              ...
              >
                Track focus patterns, productivity trends, and learning
                efficiency metrics
              </Text>
            </View>
          </View>
          ...
          >
            ...
            <View style={{ marginLeft: 12, flex: 1 }}>
              ...
              >
                AI-powered suggestions for optimal study times, break intervals,
          ...
          >
            ...
            >
              ...
              analysis is performed with anonymized data{"\n"}• Individual
              performance metrics are kept private{"\n"}• Aggregate data may be
              used to improve AI algorithms{"\n"}• You can opt-out of data
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={[styles.header, { backgroundColor: theme.card }]}>
          ...
          <Text
            style={[
              styles.headerTitle,
              { fontSize: fontSize * 1.3, color: theme.text },
            ]}
          >
            AI Integration
          </Text>
        ...
        <Text
          style={[
            ...
            { fontSize: fontSize * 0.9, color: theme.primary },
          ]}
        >
        ...
        <View style={[styles.cardSection, { backgroundColor: theme.card }]}>
          ...
          >
            ...
            <View style={{ flex: 1, marginLeft: 16 }}>
              ...
              >
                Intelligent study companion with chat, PDF analysis, and
        ...
        <View style={[styles.cardSection, { backgroundColor: theme.card }]}>
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              onValueChange={(value) =>
                handlePersonalizationToggle("contextual_suggestions", value)
              }
              trackColor={{ false: theme.border, true: theme.primary }}
              thumbColor={
                contextualSuggestions ? "#FFFFFF" : theme.textSecondary
              }
            />
          </View>
        </View>
