  ...
  const features = [
    {
      ...
      description: 'Access your study materials on the go. Upload PDFs and textbooks for easy reference during sessions.',
      icon: 'book' as const,
      color: '#4CAF50',
    ...
    },
    {
      ...
      stat: '6 assessments',
      description: 'Understand your learning style, strengths, and areas for growth through science-backed quizzes.',
      icon: 'bulb' as const,
      color: '#9C27B0',
    ...
    },
    {
      ...
      description: 'Visualize your cognitive patterns and discover how your brain performs across different focus areas.',
      icon: 'pulse' as const,
      color: '#E91E63',
      ...
      >
        ...
        <View ref={featureGridRef} collapsable={false}>
          {features.map((feature, index) => (
            <Animated.View key={feature.id} entering={FadeInUp.delay(160 + index * 80).duration(400)}>
              <Pressable
              ...
              >
                <View style={styles.featureCardHeader}>
                  <View style={[styles.featureCardIcon, { backgroundColor: feature.color + '15' }]}>
                    <Ionicons name={feature.icon} size={28} color={feature.color} />
                  </View>
                  <Ionicons name="chevron-forward" size={20} color={theme.textSecondary} />
                </View>
                <Text style={[styles.featureCardTitle, { color: theme.text }]}>{feature.title}</Text>
                <Text style={[styles.featureCardStat, { color: feature.color }]}>{feature.stat}</Text>
                <Text style={[styles.featureCardDesc, { color: theme.textSecondary }]}>{feature.description}</Text>
              </Pressable>
            </Animated.View>
          ))}
        </View>
