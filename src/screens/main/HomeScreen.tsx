...
export default function HomeScreen() {
  ...
  } = useScreenWalkthrough("home", walkthroughRefs, {
    forceShow: forceFromOnboarding,
  });
  ...
  useEffect(() => {
    stopPlayback().catch((error) => {
      // Failed to stop music on home screen
    });
  }, [stopPlayback]);
  ...
  return (
    <SafeAreaView
      style={[
        styles.container,
        { backgroundColor: environmentColors.background },
      ]}
    >
      ...
      >
        ...
        <View style={styles.topContent}>
          ...
          <Animated.View style={[styles.quoteContainer, quoteEntranceStyle]}>
            ...
            <Text
              style={[
                styles.quoteAuthor,
                { color: environmentColors.text + "80" },
              ]}
            >
          ...
          <Animated.View
            style={[styles.centralImageContainer, imageEntranceStyle]}
          >
        ...
        <Animated.View
          style={[buttonEntranceStyle, focusButtonAnimation.animatedStyle]}
        >
          <Pressable
            ref={focusButtonRef}
            collapsable={false}
            style={[
              styles.mainFocusButton,
              { backgroundColor: environmentColors.primary },
            ]}
      ...
      <View
        style={[
          ...
          { borderTopColor: environmentColors.border },
        ]}
      >
            ...
            style={[
              ...
              styles.centerNavButton,
              {
                backgroundColor: theme.isDark
                  ? "#2A2A2A"
                  : environmentColors.card,
                borderWidth: theme.isDark ? 2 : 0,
                borderColor: theme.isDark
                  ? environmentColors.primary
                  : "transparent",
              },
            ]}
          >
      ...
      >
        <View style={styles.modalOverlay}>
          ...
          >
            <Text
              style={[styles.modalTitle, { color: environmentColors.text }]}
            >
              Create New Task
            </Text>
            ...
            <Text
              style={[styles.priorityLabel, { color: environmentColors.text }]}
            >
              Priority Level:
            </Text>
