      ...
      >
        ...
        <View style={styles.pricingContainer}>
          ...
          >
            ...
            <Text style={[styles.priceDescription, { color: "#E3F2FD" }]}>
              Ultimate study experience with all features
            </Text>
          </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.9}
        >
          <Text style={[styles.subscribeButtonText, { color: "#FFF" }]}>
            Unlock HikeWise Pro
          </Text>
        </TouchableOpacity>
        ...
        <View style={styles.linksContainer}>
          ...
          <Text style={[styles.linkSeparator, { color: theme.textSecondary }]}>
            |
          </Text>
          <TouchableOpacity>
            <Text style={[styles.linkText, { color: theme.textSecondary }]}>
        ...
        <View style={styles.featuresList}>
          ...
          <View style={styles.featureCard}>
            ...
            <Text style={[styles.featureDesc, { color: theme.textSecondary }]}>
              Custom schedules tailored to your learning style
            </Text>
          </View>
          ...
          <View style={styles.featureCard}>
            ...
            <Text style={[styles.featureDesc, { color: theme.textSecondary }]}>
              Exclusive study guides and educational resources
            </Text>
          </View>
          ...
          <View style={styles.featureCard}>
            ...
            <Text style={[styles.featureDesc, { color: theme.textSecondary }]}>
              Curated audio for deep concentration
            </Text>
          </View>
          ...
          <View style={styles.featureCard}>
            ...
            <Text style={[styles.featureTitle, { color: theme.text }]}>
              Brain Mapping Profile
            </Text>
            <Text style={[styles.featureDesc, { color: theme.textSecondary }]}>
              Discover your unique learning patterns
            </Text>
          </View>
          ...
          <View style={styles.featureCard}>
            ...
            <Text style={[styles.featureDesc, { color: theme.textSecondary }]}>
              Unlock insights about your study habits
            </Text>
          </View>
          ...
          <View style={styles.featureCard}>
            ...
            <Text style={[styles.featureDesc, { color: theme.textSecondary }]}>
              Block distracting apps and websites during focus time
            </Text>
          </View>
          ...
          <View style={styles.featureCard}>
            ...
            <Text style={[styles.featureDesc, { color: theme.textSecondary }]}>
              Stand out in the community leaderboard
            </Text>
          </View>
        </View>
          ...
          >
            <View style={styles.testimonialCard}>
              <Text style={styles.testimonialText}>
                "HikeWise Pro transformed my study habits! The AI insights
                helped me identify my optimal study times and the personalized
                plans keep me on track. My grades have improved significantly
                since upgrading."
              </Text>
              <View style={styles.testimonialFooter}>
                <Text style={styles.testimonialAuthor}>
                  Sarah K., College Student
                </Text>
            ...
            <View style={styles.testimonialCard}>
              <Text style={styles.testimonialText}>
                "The e-books library and brain mapping features are
                game-changers. I finally understand how I learn best, and the
                app blocking feature helps me stay focused during deep work
                sessions."
              </Text>
              <View style={styles.testimonialFooter}>
                <Text style={styles.testimonialAuthor}>
            ...
            <View style={styles.testimonialCard}>
              <Text style={styles.testimonialText}>
                "Best investment in my academic career! The analytics show me
                exactly where I'm making progress and where I need more focus.
                The soundscapes are perfect for concentration."
              </Text>
              <View style={styles.testimonialFooter}>
                <Text style={styles.testimonialAuthor}>
                  Emma L., Medical Student
                </Text>
                <View style={styles.testimonialAvatar}>
                  <Ionicons name="person-outline" size={20} color="#FFF" />
                </View>
        ...
        <View style={styles.editorPicksContainer}>
          ...
          <View style={styles.editorPicksOverlay}>
            ...
            <Ionicons
              ...
              size={40}
              color="#FFA726"
              style={[styles.leftIcon, styles.rightIcon]}
            />
