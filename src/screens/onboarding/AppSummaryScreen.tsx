        ...
        >
              ...
              <View key={item.label}>
                {index > 0 && (
                  <View
                    style={[
                      styles.divider,
                      { backgroundColor: subtextColor + "20" },
                    ]}
                  />
                )}
          ...
          <View style={styles.welcomeSection}>
            ...
            <Text style={[styles.welcomeText, { color: subtextColor }]}>
              We're building a better way to study — and you're part of it from
              day one. Let's make every session count.
            </Text>
          </View>
