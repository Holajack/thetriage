...
const TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    description:
      "Learn how to begin productive study sessions with our focus methods",
  ...
  },
  {
    ...
    description:
      "Discover all the features and sections available to enhance your learning",
...
export default function AppTutorialScreen() {
  ...
  const handleComplete = async () => {
    try {
      ...
      // Onboarding completed, navigating to Main
              ...
              {step.details.map((detail, detailIndex) => (
                <View key={detailIndex} style={styles.detailItem}>
                  <View style={styles.detailNumber}>
                    <Text style={styles.detailNumberText}>
                      {detailIndex + 1}
                    </Text>
                  </View>
                  <Text
          ...
          >
            ...
            <View style={styles.tipsCard}>
              ...
              <View style={styles.tipsList}>
                ...
                >
                  • Join study groups in your field of interest.
                </Text>
                <Text
                  style={[
                    styles.tipItem,
                ...
                >
                  • Use Patrick AI for personalized study recommendations.
                </Text>
                <Text
                  style={[
                    styles.tipItem,
...
const styles = StyleSheet.create({
  ...
  stepHeaderContainer: {
    // Renamed from stepHeader
    flexDirection: "row",
    alignItems: "center",
  },
  stepIconContainer: {
    // Renamed from stepIcon
    width: 40,
    height: 40,
    borderRadius: 20, // Match FocusMethodIntroScreen sizing
    justifyContent: "center",
    alignItems: "center",
    marginRight: 16, // Consistent margin
  },
  ...
  tipsCard: {
    ...
    padding: 16,
    marginTop: 12,
    marginBottom: 20, // Match standard padding
    borderWidth: 2,
    borderColor: "rgba(255, 152, 0, 0.25)", // Match border width pattern
  },
  ...
  progressDot: {
    width: 8,
    height: 8,
    borderRadius: 4, // Match FocusMethodIntroScreen
