...
type FocusMethodNavigationProp = NativeStackNavigationProp<
...
const FOCUS_METHODS: FocusMethod[] = [
  {
    ...
    description:
      "Extended study sessions with longer breaks for complex topics and in-depth understanding.",
    studyTime: 45,
    breakTime: 15,
  ...
  },
  {
    ...
    description:
      "Short, intense bursts of focused studying with brief breaks to maintain high energy.",
    studyTime: 25,
    breakTime: 5,
  ...
  },
  {
    ...
    description:
      "Long, uninterrupted focus sessions for one subject with minimal breaks.",
    studyTime: 90,
    breakTime: 5,
          ...
          <View style={styles.featuresContainer}>
            {method.features.map((feature, idx) => (
              <View key={idx} style={styles.featureItem}>
                <View
                  style={[styles.featureDot, { backgroundColor: method.color }]}
                />
        ...
        <View style={styles.content}>
          <Animated.View style={[styles.header, headerAnimation]}>
            ...
            <Text style={styles.headerSubtitle}>
              Step 4 of 5 • Select the study technique that best fits your
