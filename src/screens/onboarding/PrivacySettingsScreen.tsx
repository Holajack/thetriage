...
type PrivacySettingsNavigationProp = NativeStackNavigationProp<
  ...
  "PrivacySettings"
>;
type PrivacySettingsRouteProp = RouteProp<
  OnboardingStackParamList,
  "PrivacySettings"
>;
...
const PRIVACY_SETTINGS: PrivacySetting[] = [
  ...
  },
  {
    ...
    description: "Display your study statistics and achievements publicly",
    defaultValue: true,
  ...
  },
  {
    ...
    description: "Include your scores in community leaderboards",
    defaultValue: true,
    icon: "trophy-outline",
    category: "profile",
  },
  {
    id: "studySessionVisibility",
    title: "Study Session Visibility",
    description: "Allow others to see when you're studying",
    defaultValue: false,
    icon: "time-outline",
    category: "activity",
  },
  {
    ...
    description: "Allow others to join your study rooms",
    defaultValue: true,
    icon: "people-outline",
    category: "activity",
  },
  {
    ...
    description: "Share your general location with study groups",
    defaultValue: false,
  ...
  {
    id: "studyInvites",
    title: "Study Invitations",
    description: "Receive invitations to join study sessions",
    defaultValue: true,
    icon: "mail-outline",
    category: "communication",
  },
  ...
  },
  {
    ...
    description: "Use your data to provide personalized study suggestions",
    defaultValue: true,
    icon: "bulb-outline",
    category: "data",
  },
...
export default function PrivacySettingsScreen() {
  ...
  const handleContinue = async () => {
    try {
      await updateOnboarding({
        ...
        study_session_visibility: settings.studySessionVisibility
          ? "visible"
          : "hidden",
        public_study_rooms: settings.shareStudyRooms,
        location_sharing_preference: settings.locationSharing
          ? "enabled"
          : "disabled",
      ...
      >
        <View style={styles.settingHeaderContainer}>
          ...
          <Switch
            ...
            trackColor={{
              false: theme.isDark ? theme.border : "rgba(232, 245, 233, 0.2)",
              true: "rgba(76, 175, 80, 0.4)",
            }}
            thumbColor={
              isEnabled ? "#4CAF50" : theme.isDark ? theme.text : "#E8F5E9"
            }
            ios_backgroundColor={
              theme.isDark ? theme.border : "rgba(232, 245, 233, 0.2)"
            }
  ...
  const renderCategory = (category: keyof typeof CATEGORY_TITLES) => {
    const categorySettings = PRIVACY_SETTINGS.filter(
          ...
          >
            ...
            >
              ...
              <View style={styles.noticeContent}>
                ...
                >
                  You can change these settings anytime in your profile. We are
...
const styles = StyleSheet.create({
  ...
  headerTextContainer: {
    // To center the text when back button is present
    flex: 1,
    alignItems: "center",
  },
  headerTitle: {
  ...
  settingHeaderContainer: {
    // Renamed from settingHeader for clarity
    flexDirection: "row",
    alignItems: "center",
  },
  settingIconContainer: {
    // Renamed from settingIcon
    width: 40,
    height: 40,
    borderRadius: 20, // Consistent icon container size
    justifyContent: "center",
    alignItems: "center",
