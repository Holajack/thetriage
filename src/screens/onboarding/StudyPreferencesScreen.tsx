...
type StudyPreferencesNavigationProp = NativeStackNavigationProp<
  OnboardingStackParamList,
  "StudyPreferences"
>;
type StudyPreferencesRouteProp = RouteProp<
  OnboardingStackParamList,
  "StudyPreferences"
>;
...
const SOUND_OPTIONS: SoundOption[] = [
  ...
  },
  {
    id: "ambient",
    name: "Ambient Music",
    description: "Soft instrumental background",
...
const ENVIRONMENT_OPTIONS: EnvironmentOption[] = [
  {
    id: "library",
    name: "Library",
    description: "Quiet, academic atmosphere",
  ...
  },
  {
    id: "home_office",
    name: "Home Office",
    description: "Comfortable, personal space",
    icon: "home-outline",
  },
  {
    id: "outdoor",
    name: "Outdoor",
    description: "Fresh air and natural surroundings",
    icon: "flower-outline",
  },
  {
    id: "coworking",
    name: "Co-working Space",
    description: "Collaborative, energetic environment",
    icon: "people-outline",
  },
];
